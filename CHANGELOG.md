...
A full native Android app built with **Kotlin + Jetpack Compose** for controlling your-pax via Bluetooth PAN.

**19 Screens:**
- `SplashScreen` — Bluetooth device discovery, PAN connection, CSRF token fetch
...
│   │   ├── data/bluetooth/  # BT discovery + PAN connection
